<!--
	FAZ A REQUISÃO DA PAǴINA DEMORAR x SEGUNDOS PARA SER RETORNADA
-->
<?php
...
<html lang="pt-br">
	...
	<body>
	    ...
	    <div class="container">
	    	...
	    	<div class="row mb-2">
				<!-- Nova maneira de centralizar uma div
					Não é muito eficaz caso a centralização for desejada em qualquer
					resolução, neste caso o d-flex justify content center é mais recomendado
				-->
	    	...
	    	<div class="row">
				...
				<!-- Os painéis foram descartados no bootstrap 4.1. O substituto para os panels são os cards -->
